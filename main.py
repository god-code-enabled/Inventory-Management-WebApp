...
# This is a list of all the data points that we want to plot
x_data = []
y_item_count = []
y_total_cost = []
y_grand_total = []  
...
=======
    ...
    # Modify the layout to fix axis range and hover points
...
=======
      ...
      # Check if item added is under budget
        if grand_total + item_total_cost > budget:
            flash("Exceeds max budget.", "error")
        else:
    # Add the item to inventory and update grand total as before
